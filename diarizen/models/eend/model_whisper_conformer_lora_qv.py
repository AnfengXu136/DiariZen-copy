...
class WhisperEncoderLayer(nn.Module):
    def __init__(self, config):
        ...
        # Apply LoRA to Q and V projections instead of feed-forward layers
        self.self_attn.q_proj = lora.Linear(self.embed_dim, self.embed_dim, r=config.lora_rank)
        self.self_attn.v_proj = lora.Linear(self.embed_dim, self.embed_dim, r=config.lora_rank)
